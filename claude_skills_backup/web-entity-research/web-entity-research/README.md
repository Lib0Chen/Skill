...
- 输出 1：verified_mapping.csv（Search_Key, Search_Query, Target_URL, Note）
- 输出 2：scraped_data.csv（raw_content/raw_html/matrix_json + screenshot_path）
- 输出 3：final_report.csv 或矩阵型页面导出的 results/*.csv
